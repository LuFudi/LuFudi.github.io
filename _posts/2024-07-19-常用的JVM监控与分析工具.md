...
5、也可以将dump文件上传至专门的分析平台上：http://fastthread.io/，可以将所有线程按照CPU占用排序，若占用高CPU的线程栈都一致，可以找到资源消耗的具体方法，从而定位问题原因
![img](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/jvm/cpu-percent-100-d6c9bc1c-9600-47f2-9ff1-d0c9bd8ef849.jpg)
